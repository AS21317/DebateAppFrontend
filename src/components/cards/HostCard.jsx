...
const HostCard = () => {
  return (
   <>
   <div class="mx-auto bg-white mt-4 mr-4 flex  flex-col items-center rounded-xl border px-3 py-4 text-center md:max-w-lg md:flex-row md:items-start md:text-left">
