...
const Profile = ({ user, disable = false }) => {
  ...
  const handleInputChange = (e) => {
    ...
    if (nameParts.length === 1) {
      ...
      updatedFormData[parent] = { ...updatedFormData[parent], [child]: value };
    }
  ...
  const updateProfileHandler = async (e) => {
    e.preventDefault();
    console.log("called here updation is here  ", formData);
        
    setLoading(true);
    
    try {
      const res = await fetch(
        `${import.meta.env.VITE_BASE_URL}/api/v1/user/update/${user._id}`,
        {
          method: "PUT",
          headers: {
      ...
      <div>
        ...
        <form onSubmit={updateProfileHandler}>
          ...
          <div className="mb-10 mt-10">
            <p className="form__label ">Social Links*</p>

            <div>
              <div>
                <div className="grid grid-cols-2 gap-5">
                  <div>
                    <p className="form__label">Instagram*</p>
                    <input
                      type="text"
                ...
                <div className="grid grid-cols-2 gap-5 mt-5">
                  ...
                  <div>
                    <p className="form__label">Youtube*</p>
                    <input
                      type="text"
          ...
          <div className="mb-5">
            <p className="form__label text-lg font-bold">Qualifications*</p>
          ...
          <div className="mb-5">
            <p className="form__label text-lg font-bold">Experiences*</p>
